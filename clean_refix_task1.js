...
const postsData = [
    { id: 'post1.html', title: "My Evening Wind-Down Routine", category: "barrier", date: "July 01", img: "images/content-pixie-Q0y-1aorvJo-unsplash.webp", excerpt: "How I take the day off and prep my skin for overnight recovery to wake up with a balanced glow.", content: `
                ...
                <h2>Step 1: The "Melt" (Double Cleanse Part 1)</h2>
                <p>If you wear SPF or makeup, a water-based cleanser alone isn't going to cut it. I start with a soothing cleansing balm. I massage it into my dry skin for a full minute to break down stubborn mascara without scrubbing.</p>

                <h2>Step 2: The Clean Slate (Double Cleanse Part 2)</h2>
                <p>Next, I go in with a gentle, non-foaming hydrating cleanser. Your skin should never feel "squeaky clean" or tight after this step. If your cleanser makes your face feel like a desert, it's too harsh!</p>

                <h2>Step 3: The Prep & Treat</h2>
                <p>While my skin is still slightly damp, I pat in a hydrating serum. Applying it to damp skin pulls that moisture deep into the epidermis, ensuring you wake up with plump, rested skin.</p>
    ...
    ` },
    { id: 'post2.html', title: "My Honest Morning Routine", category: "rituals", date: "June 23", img: "images/poko-skincare-oXI2_S1ILQI-unsplash.webp", excerpt: "I’ve finally nailed down a routine that keeps my skin hydrated and glowing without feeling heavy.", content: `
                <p>I’ll be the first to admit it: my skincare routine used to be exhausting. I thought I needed a ten-step process to achieve that elusive "glass skin," but in reality, all I got was an empty wallet and skin that felt overwhelmed and congested.</p>
                <p>Over the last year, I’ve drastically simplified my mornings. I’ve realized that when it comes to the start of the day, protection and hydration are the only true goals. Here is the honest, paired-down routine I actually stick to:</p>
    ...
    ` },
    { id: 'post3.html', title: "5 Affordable Skincare Products", category: "reviews", date: "June 22", img: "images/ibnu-ihza-QbHwPe1HE84-unsplash.webp", excerpt: "You don’t need to spend a fortune to get great skin. These budget-friendly finds have earned their spot.", content: `
    ...
    ` },
    { id: 'post4.html', title: "Peptides Explained", category: "science", date: "June 21", img: "images/plantadea-zSD0OWrbtlw-unsplash.webp", excerpt: "They’re the buzziest ingredient right now, but what do peptides actually do? Let's break down the science.", content: `
    ...
    ` },
    { id: 'post5.html', title: "Gentle Exfoliation", category: "rituals", date: "June 20", img: "images/young-lady-pointing-phone-sign-white-bathrobe-towel-looking-pleased-front-view.webp", excerpt: "Here’s what happened when I put down the strong peels and switched to a kinder, more effective approach.", content: `
    ...
    ` },
    { id: 'post6.html', title: "Skin Barrier 101", category: "barrier", date: "June 19", img: "images/christian-agbede-TqmyIxQpo5s-unsplash.webp", excerpt: "Understand why the skin barrier is the most important factor in your routine and how to fix a compromised one.", content: `
    ...
    ` },
    { id: 'post7.html', title: "The Truth About Eye Creams", category: "reviews", date: "June 17", img: "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?q=80&w=1200", excerpt: "Are eye creams a true must-have or just an expensive moisturizer? Let's look at the facts.", content: `
    ...
    ` },
    { id: 'post8.html', title: "Evening Wind-Down Routine", category: "barrier", date: "July 01", img: "images/content-pixie-Q0y-1aorvJo-unsplash.webp", excerpt: "Prep my skin for overnight recovery with a simple 5-step routine that actually works.", content: `
                <p>By the time 8 PM rolls around, my brain is usually fried from staring at screens all day, and my skin feels completely suffocated. Between the commute, the office AC, and the stress of balancing a busy schedule, my evening skincare routine has become less about "fixing" my face and more about preserving my sanity.</p>
                <p>I don't do a 10-step routine. I don't have the energy for it, and honestly, neither does my skin barrier. My goal at night is simple: take the day off, release the physical tension in my face, and flood my skin with hydration so it can repair itself while I sleep.</p>
    ...
    ` },
    { id: 'post9.html', title: "The Science of Hyaluronic Acid", category: "science", date: "July 05", img: "https://images.unsplash.com/photo-1556228578-0d85b1a4d571?q=80&w=1200", excerpt: "Is HA really the hydration hero it's claimed to be? Let's look at the molecular science behind this ingredient.", content: `
                <p>Hyaluronic acid (HA) is often hailed as the "holy grail" of skin hydration. You’ll find it in everything from luxury serums to drugstore cleansers, often paired with claims that it can hold up to 1,000 times its weight in water. But while HA is a powerful humectant, the way you use it matters more than the percentage in the bottle.</p>
                
                <h2>The Molecular Weight Problem</h2>
                <p>Not all hyaluronic acid is created equal. The size of the HA molecule determines how deep it can penetrate the skin. High-molecular-weight HA sits on the surface, creating a film that prevents moisture loss. Low-molecular-weight HA can travel deeper into the epidermis, but it can also sometimes trigger inflammation in very sensitive skin.</p>

                <h2>How to Use it Correcty</h2>
                <p>If you apply HA to bone-dry skin in a dry climate, it can actually pull moisture *out* of your deeper skin layers to hydrate the surface. This leaves your skin feeling tighter and drier than before. The secret? Always apply HA to slightly damp skin and immediately seal it with an occlusive moisturizer.</p>

                <p>Our <strong>SkinHonestly Daily Reset Serum</strong> uses a multi-weight HA complex to ensure both surface smoothing and deep-level plumping without the risk of irritation.</p>
    `, shopItems: `
                <div class="shop-widget-item">
                    <img src="https://images.unsplash.com/photo-1620916566398-39f1143ab7be?q=80&w=200" alt="Serum">
                    <div>
    ...
    ` },
    { id: 'post10.html', title: "Retinol for Beginners", category: "reviews", date: "July 10", img: "https://images.unsplash.com/photo-1617897903246-719242758050?q=80&w=1200", excerpt: "The clinical guide to introducing retinoids without destroying your barrier. Start your retinol journey safely.", content: `
                <p>Retinol is often called the "gold standard" of anti-aging, but it’s also the most abandoned product in skincare. Why? Because most people rush into it, experience the "retinoid purge" or intense irritation, and assume the product is simply too harsh for their skin. In reality, retinol just requires a very specific introduction protocol.</p>
                
                <h2>Low and Slow</h2>
                <p>The clinical secret to retinol success is starting at a low concentration (around 0.25%) and only using it twice a week for the first 28 days. This allows your skin cells to adjust to the increased turnover rate without overwhelming your barrier.</p>

                <h2>The "Sandwich" Method</h2>
                <p>If you have sensitive skin, try applying a layer of moisturizer, then your retinol, then another layer of moisturizer. This "sandwich" doesn't reduce the efficacy of the retinol over time, but it significantly reduces the immediate irritation and redness.</p>

                <p>When using retinol, always pair it with a barrier-repairing treatment like our <strong>Bakuchiol Night Oil</strong> on your "off" nights to keep your skin foundation strong.</p>
    `, shopItems: `
                <div class="shop-widget-item">
                    <img src="https://images.unsplash.com/photo-1617897903246-719242758050?q=80&w=200" alt="Night Oil">
                    <div>
                        <h5>Bakuchiol Night Oil</h5>
                        <a href="shop.html" class="shop-btn">View in Shop</a>
                    </div>
...
postsData.forEach(p => {
        ...
        relatedHtml += \`
            <article class="post-card">
                ...
                <div class="post-content">
                    ...
                    <p class="post-excerpt">\${rp.excerpt}</p>
    ...
    // 2. Build Entire Page HTML from scratch to ensure zero duplications
...
<body>
    ...
    <main class="article-layout">
        <div class="article-body">
            <header class="article-header">
                <span class="cat-tag">\${p.category.toUpperCase()} • RITUALS</span>
                <h1>\${p.title}</h1>
    ...
    console.log("CLEAN REBUILT: " + fileName);
});
