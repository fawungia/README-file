...
<head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,500;0,600;1,500&family=Inter:wght@300;400;600;700&display=swap">
...
<body>
    ...
    <main class="article-layout">
        <div class="article-body">
            ...
            <img src="${post.img}" alt="${post.title}" class="main-img" fetchpriority="high">
